...
describe('#Reports API', () => {
  it('creates correct instance', () => {
    ...
    expect(reportsAPI).toHaveProperty('getIntegrationSgcReport');
  });
  describe('API calls', () => {
    ...
    it('#getIntegrationSgcReport', () => {
      ...
      window.history.replaceState(
        {},
        '',
        '/app/accounts/1/reports/integracion_sgc'
      );

      reportsAPI.getIntegrationSgcReport({ signal: controller.signal });

      expect(axiosMock.get).toHaveBeenCalledWith(
        '/api/v2/accounts/1/integration_sgc_report',
        { signal: controller.signal }
      );
    ...
    it('#getIntegrationSgcReport with a custom date range', () => {
      const originalPath = window.location.pathname;
      ...
      reportsAPI.getIntegrationSgcReport({
        fromDate: '2026-07-01',
        toDate: '2026-07-29',
      });
    ...
    it('#getIntegrationSgcReport with all history', () => {
      const originalPath = window.location.pathname;
      ...
      reportsAPI.getIntegrationSgcReport({ all: true });
